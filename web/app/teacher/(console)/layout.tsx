...
const nav = [
  { href: '/teacher/new-course', icon: 'plus' as const, label: '新建课程', desc: '创设课堂语境' },
...
export default function TeacherConsoleLayout({ children }: { children: React.ReactNode }) {
        ...
        <div className="lg:sticky" style={{ top: 24 }}>
          ...
          <div className="card flex items-center gap-3 p-4">
            ...
            <div className="min-w-0">
              <p className="truncate text-sm font-bold text-ink">李老师</p>
              <p className="mt-0.5 truncate text-xs text-ink-faint">龙头山镇中心小学 · 三 (1) 班</p>
            </div>
          </div>
