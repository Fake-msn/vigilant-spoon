...
def _species_for(ideal: str | None) -> str:
    ...
    rules = [
        ...
        ("工程师", "engineer"), ("建筑", "engineer"), ("修路", "engineer"), ("造桥", "engineer"), ("机械", "engineer"), ("建造", "engineer"),
        ("音乐", "musician"), ("歌手", "musician"), ("钢琴", "musician"), ("小提琴", "musician"), ("作曲", "musician"), ("唱歌", "musician"), ("演奏", "musician"),
        ("运动员", "athlete"), ("跑步", "athlete"), ("足球", "athlete"), ("篮球", "athlete"), ("奥运", "athlete"), ("冠军", "athlete"), ("体育", "athlete"),
        ("作家", "writer"), ("写作", "writer"), ("作者", "writer"), ("小说", "writer"), ("诗人", "writer"), ("写书", "writer"), ("写故事", "writer"),
